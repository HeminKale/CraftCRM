-- Migration: 146_fix_button_functions_debug.sql
-- Fix button functions with better error handling and debugging
...
-- Function to create a new button with better error handling
...
DO $$
BEGIN
  RAISE NOTICE '✅ Migration 146 completed: Fixed button functions with better error handling';
END $$;
