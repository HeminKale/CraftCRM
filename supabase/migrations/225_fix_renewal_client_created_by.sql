-- Migration 225: Populate created_by and updated_by in create_renewal_client
--
-- The RPC was inserting renewal records without setting created_by / updated_by.
-- Fix: resolve the caller's full name via current_user_full_name() and write it
-- into both columns on INSERT.
