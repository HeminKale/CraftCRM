-- Migration 107: Step-by-Step Organizational Cleanup
...
BEGIN
    ...
    BEGIN
        ...
        -- Drop all autonumber triggers
        IF trigger_count > 0 THEN
            -- Drop triggers by name pattern (without CASCADE - not supported for triggers)
            EXECUTE 'DROP TRIGGER IF EXISTS set_autonumber_value';
            RAISE NOTICE '✅ Dropped all autonumber triggers';
        END IF;
    END;
END $$;
